...
#include "../tmk_keyboard/keyboard/kb60/keymap_common.h"
...
const uint8_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KEYMAP_KB60(
        ...
        CAPS, A,    S,    D,    F,    G,    H,    J,    K,    L,    SCLN, QUOT, P7,   ENT,  \
        LSFT, X,    Z,    X,    C,    V,    B,    N,    M,    COMM, DOT,  SLSH, P5,   RSFT, \
        LCTRL,LGUI, LALT,             SPC,                    P8,   RALT, RGUI, FN1,  RCTRL \
        ),
    ...
    KEYMAP_KB60(
        ...
        TRNS, TRNS, TRNS, APP,  FN2,  FN3,  FN4,  VOLD, VOLU, MUTE, END,  PGDN, TRNS, TRNS, \
    ...
    KEYMAP_KB60(
        ...
        TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, P1,   P2,   P3,   PPLS, PAST, TRNS, TRNS, \
        TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, TRNS, P0,   PCMM, PDOT, PSLS, TRNS, TRNS, \
